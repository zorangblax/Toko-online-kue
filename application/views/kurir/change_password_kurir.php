<div class="container-fluid">
    <div class="row">
        ...
        <div class="col-md-8">
            ...
            <?php endif; ?>
            <br>
            <form method="post" action="<?php echo base_url('edit_profile/change_password_kurir') ?>">
                ...
                <a class="btn btn-sm btn-primary" href="<?php echo base_url('edit_profile/kurir') ?>">Kembali</a>
            </form>
